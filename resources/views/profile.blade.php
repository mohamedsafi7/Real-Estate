            ...
            <div class="property-item rounded overflow-hidden mb-4">
                ...
                <div class="p-4 pb-0">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        @php
                            $pendingReservationsCount = $pub->reservations->count();
                        @endphp
                        @if ($pendingReservationsCount > 0)
                            <span class="badge bg-success">
                                <i class="fas fa-bell"></i> {{ $pendingReservationsCount }}
                            </span>
                        @endif
                    </div>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <a href="{{ route('editproperty', $pub->id) }}" class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a>
